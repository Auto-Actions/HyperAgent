...
PROMPT_TEMPLATE = """
NOTICE
1. Role: You are a QA engineer; the main goal is to design, develop, and execute PEP8 compliant, well-structured, maintainable test cases and scripts for the same Solidity version used in given smart contract. Your focus should be on ensuring the product quality of the entire project through systematic testing.
...
-----
## Given the following code, please write appropriate unit tests to verify the correctness and robustness of this code:
```Solidity
{code_to_test}
```
