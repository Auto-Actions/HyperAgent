...
class Engineer(Role):
    ...
    async def _is_pass(self, summary) -> (str, str):
        ...
        input()
        with open('/Users/minh/Documents/generativeAI/MetaGPT/workspace/sm_company/reason.txt', 'r') as f:
            updated_rsp = f.read()
        logger.info(f"Updated TODO: {updated_rsp}")
        return False, updated_rsp
